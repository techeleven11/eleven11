...
<div class="mainContainer">
    <div class="howto-playSec">    	
        <div class="howto-play-banner" style="background-image: url('assets/img/howto-play-banner.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="how text-white text-center">
                            <h1 class="text-uppercase"> How to Play ? </h1>
                                                ...
                                                <div class="Select-match mt-4">
                                                    ...
                                                    <div class="d-flex mt-3">
                                                        <div class="col-4 pl-0 step-images">
                                                            <img src="assets/img/select-a-match.jpg">
                                                        </div>
                                    ...
                                    <div class="col-lg-8 offset-lg-4 col-md-9 offset-md-3 py-5 steps text-center">
                                        ...
                                        <div class="px-0 px-md-4 px-lg-5">
                                            ...
                                            <div id="read_more3" class="collapse">
                                                <div class="winnings">
                                                    <div class="mt-3">
                                                        <p> You can view, withdraw or deposit money into your <strong>FSL11 account</strong> anytime by going to the <span class="d-md-none">My Account</span> <a class="d-none d-md-inline-block" href="myAccount">My Account</a> link. </p>
