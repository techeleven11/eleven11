...
<html  lang="en" data-ng-app="FSL11" ng-cloak  >
    <head>
        ...
        <link rel="icon" type="png/jpg" href="<?= $path; ?>assets/img/fav1.png"> 
        <link rel="stylesheet" type="text/css" href="<?= $path; ?>assets/css/jquery.mCustomScrollbar.css">
        <link href="<?= $path; ?>assets/css/slick.css" rel="stylesheet">
        <link href="<?= $path; ?>assets/css/slick-theme.css" rel="stylesheet">
        <link href="<?= $path; ?>assets/css/quicksand-font.css" rel="stylesheet">
        <link href="<?= $path; ?>assets/css/custom.css?version=<?= VERSION ?>" rel="stylesheet">
        <link href="<?= $path; ?>assets/css/draftcustom.css?version=<?= VERSION ?>" rel="stylesheet">
        <link href="<?= $path; ?>assets/css/responsive.css?version=<?= VERSION ?>" rel="stylesheet">
        <link rel="stylesheet" href="<?= $path; ?>index_file/custom.css?version=<?= VERSION ?>">
        <link href="https://cdn.gitcdn.link/cdn/angular/bower-material/v1.1.10/angular-material.css" rel="stylesheet">
        <script type="text/javascript" src="<?= $path; ?>auctionDraft/node_modules/socket.io-client/dist/socket.io.js" ></script>
        <?php if($ServerName == 'https://fsl11.com'){ ?>
...
<body ng-controller="MainController" ng-cloak class="{{(type == 'mobile')?'andoridHeader':''}}">
    <?php if($ServerName == 'https://fsl11.com'){ ?>
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg" ng-if="!isLoggedIn">
                    <a class="navbar-brand text-white signin_logo" href="<?= $base_url; ?>" ng-if="type != 'mobile'"> 
                        <img src="<?= $path; ?>assets/img/logo.png" alt="logo" ng-if="secondLevelLocation != 'authenticate'" style="position: absolute; left: 0;z-index: 9;"> 
                        <img src="<?= $path; ?>assets/img/logo.png" alt="logo" ng-if="secondLevelLocation == 'authenticate'" class="ml-sm-3">
                    </a>

                    <div class="col-lg-12 col-md-6 pr-0 pr-sm-3">   <!-- ng-if="secondLevelLocation != 'authenticate'" -->
                        <ul class="nav justify-content-end login_menu d-flex mt-lg-3">
                            <li class="nav-item mr-1 mr-sm-3"> <a href="<?= $path; ?>download-fantasy-cricket-app" class="join_btn text-dark"> Download App </a></li>
                    ...
                    <div class="navbar-collapse collapse" id="navb">
                        <ul class="navbar-nav rightNav" >               
                            <li class="nav-item wallet_icon"> 
                                <a href="<?= $path;?>myAccount" data-toggle="tooltip" title="Click to view wallet"><img src="<?= $path; ?>assets/img/wallet.svg" alt="wallet"/></a>
                                <a href="<?= $path;?>myAccount" data-toggle="tooltip" title="Click to view wallet"><img src="<?= $path; ?>assets/img/wallet-yello.svg" alt="wallet"></a>
                            </li>
                            ...
                            <li class="dropdown accountDrop bdr d-flex">
                                ...
                                <div class="dropdown-menu helpCenter">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="<?= $path; ?>faq">FAQs  </a></li>
                                        <li><a href="<?= $path; ?>Legalities">Legality  </a></li>
                                        <li><a href="<?= $path; ?>PointSystem">Point System  </a></li>
                                        <li><a href="<?= $path; ?>privacyPolicy">Privacy Policy  </a></li>
                                        <li><a href="<?= $path; ?>TermConditions">Term & Conditions  </a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="dropdown accountDrop mr-2">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <ul class="userSettings">
                                        <li><a href="<?= $path; ?>profile"> <i class="fa fa-fw fa-user"></i> Profile</a></li>
                                        <li><a href="<?= $path; ?>myAccount"><i class="fa fa-user-circle"></i> My Account</a></li>
                                        <li><a href="<?= $path; ?>changePassword"><i class="fa fa-user-circle"></i> Change Password</a></li>
                                        <li><a href="<?= $path; ?>settings"><i class="fa fa-fw fa-gear"></i> Verify Accounts</a></li>
                                        <li><a href="<?= $path; ?>Coupons"> <i class="fa fa-shopping-basket"></i> Offers</a></li>
                                        <li><a href="<?= $path; ?>referAndEarn"> <i class="fa fa-money"></i> Refer &amp; Earn </a></li> 
                        ...
                        <ul class="navbar-nav mr-auto mt-2">
                            ...
                            <li class="nav-item {{headerActiveMenu=='lobbyFootball' ? 'active' : '' }}">
                             ...
                             <li class="nav-item {{headerActiveMenu=='auction' ? 'active' : '' }}  ">
                                 <a class="nav-link" href="<?= $path;?>auction"> Auction </a>
                             </li>
                             <li class="nav-item {{headerActiveMenu=='snakeDraft' ? 'active' : '' }}  ">
                                 <a class="nav-link" href="<?= $path;?>snakeDraft"> Gully Fantasy </a>
                             </li> 
                            ...
                            <li class="nav-item dropdown accountDrop">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        <li class="{{headerActiveMenu=='leagueCenter' ? 'active' : '' }} "><a href="<?= $path; ?>leagueCenter" > DFS </a></li>
                                         <li class="{{headerActiveMenu=='auctionLeagueCenter' ? 'active' : '' }}"><a href="<?= $path; ?>auctionLeagueCenter"> Auction </a></li>
                                         <li class="{{headerActiveMenu=='draftLeagueCenter' ? 'active' : '' }}"><a href="<?= $path; ?>draftLeagueCenter"> Gully Fantasy </a></li> 
                                    </ul>
                                </div>
                            </li>
                ...
                <div class="onlyMobileMenu " ng-if="isLoggedIn" >
                    <ul class="navbar-nav rightNav" >
                        ...
                        <li class="nav-item wallet_icon"> 
                            <a href="<?= $path; ?>myAccount"><img src="<?= $path; ?>assets/img/wallet.svg" alt="wallet"/></a>
                            <a href="<?= $path; ?>myAccount"><img src="<?= $path; ?>assets/img/wallet-yello.svg" alt="wallet"></a>
                        </li>
                        <li class="nav-item">
